defmodule SemesterProjectWeb.Router do
  ...
  import SemesterProjectWeb.UserAuth
  ...
  scope "/", SemesterProjectWeb do
    ...
    live_session :redirect_if_user_is_authenticated,
      on_mount: [{SemesterProjectWeb.UserAuth, :redirect_if_user_is_authenticated}] do
  ...
  scope "/", SemesterProjectWeb do
    ...
    live_session :require_authenticated_user,
      on_mount: [{SemesterProjectWeb.UserAuth, :ensure_authenticated}] do
  ...
  scope "/", SemesterProjectWeb do
    ...
    live_session :current_user,
      on_mount: [{SemesterProjectWeb.UserAuth, :mount_current_user}] do
