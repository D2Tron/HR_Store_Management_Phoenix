defmodule SemesterProject_HRWeb.EmployeeController do
  ...
  def create(conn, %{"employee" => employee_params}) do
    case HR.create_employee(employee_params) do
      {:ok, employee} ->
        #Send Broadcast
        SemesterProject_HRWeb.Endpoint.broadcast("employee:lobby", "create", %{})
        conn
  ...
  def update(conn, %{"id" => id, "employee" => employee_params}) do
    ...
    case HR.update_employee(employee, employee_params) do
      {:ok, employee} ->
        SemesterProject_HRWeb.Endpoint.broadcast("employee:lobby", "update", %{})
        conn
