defmodule SemesterProject_HRWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(SemesterProject_HRWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(SemesterProject_HRWeb.Gettext, "errors", msg, opts)
    end
  end
